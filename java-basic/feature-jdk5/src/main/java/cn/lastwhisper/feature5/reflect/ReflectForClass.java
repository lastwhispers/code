...
public class ReflectForClass {
    ...
    public void classforName() throws Exception {
        Class clazz1 = Class.forName("cn.lastwhisper.feature5.reflect.pojo.MyObject");
        Class clazz2 = Class.forName("cn.lastwhisper.feature5.reflect.pojo.MyObject");
    ...
    public void reflectNewObj() throws Exception {
        Class clazz = Class.forName("cn.lastwhisper.feature5.reflect.pojo.MyObject");
