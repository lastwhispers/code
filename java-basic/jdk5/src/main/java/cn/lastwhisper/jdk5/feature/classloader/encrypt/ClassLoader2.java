package cn.lastwhisper.jdk5.feature.classloader.encrypt;
...
public class ClassLoader2 extends ClassLoader {
    ...
    public static void decryptAndLoadClass()throws Exception {
        ...
        Class<?> clazz = classLoader2.loadClass("cn.lastwhisper.jdk5.feature.classloader.encrypt.ClassLoaderAttachment");
