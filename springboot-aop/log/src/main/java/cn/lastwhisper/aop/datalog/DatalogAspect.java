package cn.lastwhisper.aop.datalog;

import cn.lastwhisper.aop.domain.Action;
import cn.lastwhisper.aop.domain.ActionType;
import cn.lastwhisper.aop.domain.ChangeItem;
import cn.lastwhisper.aop.util.DiffUtil;
...
public class DatalogAspect {
    ...
    @Pointcut("execution(public * cn.lastwhisper.aop.dao.*.save*(..))")
    public void save(){

    }

    @Pointcut("execution(public * cn.lastwhisper.aop.dao.*.delete*(..))")
    public void delete(){
